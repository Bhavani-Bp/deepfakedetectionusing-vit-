...
const API_URL_IMAGE = `${API_BASE}/predict-image`;
const API_URL_VIDEO = `${API_BASE}/predict-video`;
...
resetBtn.addEventListener('click', () => {
    ...
    previewContainer.innerHTML = '<img id="imagePreview" src="" alt="Preview">';
});
...
function showResult(data) {
    ...
    bar.style.backgroundColor = isFake ? 'var(--accent-fake)' : 'var(--accent-real)';
    ...
    if (type === 'video') {
        ...
        // Use the original preview or maybe update it if backend sends a crop?
        // Ideally backend could send the crop used for prediction too.
    }
}
